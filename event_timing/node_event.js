...
console.log('<4.1> schedule with process.nextTick');
process.nextTick(function () {
    console.log('[4.1] process.nextTick boom!');
    let string = "";
    ...
    console.log('[4.1] end', string.length);
});

console.log('<4.2> schedule with process.nextTick');
process.nextTick(function () {
    console.log('[4.2] process.nextTick boom!');
});
